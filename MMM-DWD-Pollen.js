    ...
    function writePollen(
      ...
      function designPollen(tableElement, pollenValue) {
        ...
        if (iconPollen) {
          ...
          if (pollenValue === "3") {
             tableElement.innerHTML+="<img class='pollenimg' src=\"./modules/MMM-DWD-Pollen/icons/pollen_full_gr.png\"></img>";
             tableElement.innerHTML+="<img class='pollenimg' src=\"http://broker:8082/vis.0/main/img/magicmirror/pollen_full_gr.png\"></img>";
             tableElement.innerHTML+="<img class='pollenimg' src=\"http://broker:8082/vis.0/main/img/magicmirror/pollen_full_gr.png\"></img>";
             tableElement.className = "pollen-high";
          } else if(pollenValue == "2-3") {
             tableElement.innerHTML+="<img class='pollenimg' src=\"http://broker:8082/vis.0/main/img/magicmirror/pollen_full_gr.png\"></img>";
             tableElement.innerHTML+="<img class='pollenimg' src=\"http://broker:8082/vis.0/main/img/magicmirror/pollen_full_gr.png\"></img>";
             tableElement.innerHTML+="<img class='pollenimg' src=\"http://broker:8082/vis.0/main/img/magicmirror/pollen_half_gr.png\"></img>";
             tableElement.className = "pollen-mediumhigh";
          } else if(pollenValue == "2") { 
             tableElement.innerHTML+="<img class='pollenimg' src=\"http://broker:8082/vis.0/main/img/magicmirror/pollen_full_gr.png\"></img>";
             tableElement.innerHTML+="<img class='pollenimg' src=\"http://broker:8082/vis.0/main/img/magicmirror/pollen_full_gr.png\"></img>";
             ...
             tableElement.innerHTML+="<img src=\"http://broker:8082/vis.0/main/img/magicmirror/pollen_half_gr.png\"></img>";
             tableElement.className = "pollen-low";
          } else  {
	     tableElement.innerHTML+="<img src=\"http://broker:8082/vis.0/main/img/magicmirror/pollen_empty.png\"></img>";
             tableElement.className = "pollen-nodata";
          } 
/*else if (pollenValue === "2-3") {
            tableElement.innerHTML = '<div class="fa fa-star"></div>';
